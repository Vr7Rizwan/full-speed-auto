    ...
    return(
        <section className="py-10">
            <div className="w-[95%] mx-auto flex rounded-2xl bg-txtColor flex-col md:flex-row md:items-start justify-center px-4 gap-15 md:gap-20 flex-wrap py-12">
                {
                   cards.map((value,i)=>(                   
            <div key={`${value} ${i}`} className="flex flex-col justify-center items-start w-full md:w-1/4 gap-3 px-6 py-6 md:px-8 md:py-6 border-secondary border rounded-2xl">
