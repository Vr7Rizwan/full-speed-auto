    ...
    <footer className="w-full bg-txtColor text-primary py-12 px-6 md:px-12">
      <div className="flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex flex-col gap-3 md:w-1/4">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <Link href="/services/detailing" className="hover:text-secondary">
              Car Detailing
            </Link>
            <Link href="/services/repair" className="hover:text-secondary">
              Auto Repair
            </Link>
            <Link href="/services/oil-change" className="hover:text-secondary">
              Oil Change
            </Link>
            <Link href="/services/engine" className="hover:text-secondary">
              Engine Service
            </Link>
            <Link href="/services/tinting" className="hover:text-secondary">
              Tinting Service
            </Link>
            <Link href="/services/inspection" className="hover:text-secondary">
              Car Inspection
            </Link>
          </div>
        </div>
