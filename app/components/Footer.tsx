...
const Footer = () => {
    ...
    const socialLinks = [
        { icon: <Facebook className="size-5 hover:text-secondary cursor-pointer" />, href: "https://facebook.com" },
        { icon: <Instagram className="size-5 hover:text-secondary cursor-pointer" />, href: "https://instagram.com" },
        { icon: <Youtube className="size-5 hover:text-secondary cursor-pointer" />, href: "https://youtube.com" },
    ];
            ...
            <div className="flex flex-col md:flex-row justify-between gap-12">
                ...
                <div className="flex flex-col gap-3 md:w-1/4">
                    ...
                    <div className="flex flex-col gap-2 normalText">
                        {quickLinks.map((link) => (
                            <Link key={link.name} href={link.href} className="hover:text-secondary">
                                {link.name}
                            </Link>
                        ))}
                    </div>
