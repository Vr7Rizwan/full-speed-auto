    ...
    <footer className="w-full bg-txtColor text-primary py-12 px-6 md:px-12 z-20">
      <div className="flex flex-col md:flex-row justify-around gap-12">
        ...
        <div className="hidden md:flex flex-col gap-3 md:w-1/4">
          <p className="subHeading font-bold text-primary">Quick Links</p>
        ...
        <div className="hidden md:flex flex-col gap-3 md:w-1/4">
          <p className="subHeading font-bold text-primary">Useful Links</p>
          <div className="flex flex-col gap-2 normalText">
        ...
        <div className="flex flex-col gap-3 md:w-1/4">
          <p className="subHeading font-bold text-primary">Connect With Us</p>
