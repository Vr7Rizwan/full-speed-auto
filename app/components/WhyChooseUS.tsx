        ...
        <div className="flex flex-col w-full gap-5 justify-around px-5">
          {whyChooseUs &&
            whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="p-5 flex flex-col gap-5 rounded-2xl border-2 border-secondary hover:bg-secondary hover:border-txtColor hover:cursor-pointer transition-all duration-500"
              >
