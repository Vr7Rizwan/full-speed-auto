  ...
  return (
    <div
        ...
        <div className="z-30 py-15 flex items-center flex-col gap-15">
            <h1 className="text-primary font-bold text-3xl md:text-4xl">WHY CHOOSE US</h1>
            <div className="flex flex-col md:flex-row flex-wrap gap-5 justify-around px-5">
                ...
                <div
                    ...
                    <h3 className="text-primary text-[20px] md:text-2xl font-bold">{item.title}</h3>
                    <p className="text-primary text-[15px] md:text-[20px]">{item.text}</p>
                </div>
                ))}
            </div>
