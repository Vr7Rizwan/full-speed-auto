...
const CarWorkshopForm = () => {
    return (
        <section className="w-full flex flex-col md:flex-row items-center bg-gray-50 py-12 px-4 sm:px-8 lg:px-20 gap-8">
            ...
            <div
                className="w-full md:w-1/2 h-56 sm:h-72 md:h-full md:min-h-[420px] rounded-lg bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: "url('/assets/car-workshop.jpg')" }}
            ></div>

            {/* Right Form */}
            <div className="w-full md:w-1/2 bg-white p-6 sm:p-8 rounded-lg shadow-md">
